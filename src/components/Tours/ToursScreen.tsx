...
import { Play, Pause, Volume, Star } from 'lucide-react';
...
const ToursScreen = () => {
  ...
  const currentTour = {
    ...
    description: "Discover the architectural marvels and spiritual significance of ancient Tamil temples",
    totalTracks: 8,
    duration: "2h 30m",
    language: "Tamil",
  ...
  const tracks = [
    { id: 1, title: "Welcome to Brihadeeswarar Temple", duration: "3:45", completed: true },
    { id: 2, title: "The Great Architecture", duration: "5:20", completed: true },
    { id: 3, title: "Spiritual Significance", duration: "4:10", completed: false, playing: true },
    ...
    { id: 8, title: "Conclusion & Reflection", duration: "2:25", completed: false }
  ];
          ...
          <div className="absolute bottom-4 left-4 right-4 text-white">
            ...
            <div className="flex items-center space-x-4 text-sm">
              ...
              <div className="flex items-center">
                <Star className="w-4 h-40 text-yellow-400 fill-current mr-1" />
          ...
          {tracks.map((track, index) => (
            <Card
              ...
              className={`cursor-pointer transition-all ${
                index === currentTrack
                  ? 'ring-2 ring-saffron bg-saffron/5'
                  : 'hover:shadow-md'
              }`}
  ...
  <div className="flex items-center justify-between">
      ...
      <div>
        <h3
          className={`font-medium ${
            index === currentTrack ? 'text-saffron' : 'text-gray-900'
          }`}
        >
          {track.title}
        </h3>
    ...
    {index === currentTrack && (
      ...
      <div className="px-4 pb-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Cultural Tips</h2>
